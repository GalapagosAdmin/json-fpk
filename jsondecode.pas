...
var
  ptr:integer=1;  // This is where the \uXXXX starts
...
//   ParC:Char;   // Closing Parenthesis or similar (Matring to ParO)           //@001-
   ...
   NestCount:Integer=0; // Nesting Level: 1 = top level list.
   CopyPos:Integer=1;  // Starting Position for CopyStop function
   TmpStr:String;
   InQuote:Boolean=False;                                                       //@003+
  begin
